...
VARIANT_DIR_TO_NAME = {
    ...
    "snn_actor_snn_timing_critic": "STC (our model)",
    "poc_snn_actor_snn_timing_critic": "STC (our model)",
    "tmaze_snn_actor_snn_timing_critic_active": "STC (our model)",
    "tmaze_snn_actor_snn_timing_critic_passive": "STC (our model)",
