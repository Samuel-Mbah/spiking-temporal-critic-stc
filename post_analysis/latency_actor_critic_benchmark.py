...
TASKS: List[TaskSpec] = [
    TaskSpec(
        ...
        snn_root="results/logs/cartpole/snn_actor_snntiming_critic",
        ann_mode="ann",
    ...
    TaskSpec(
        ...
        snn_root="results/logs/partial_cartpole/poc_snn_actor_snntiming_critic",
        ann_mode="ann",
        snn_mode="snn_actor_snn_timing_critic",
    ),
    TaskSpec(
        ...
        snn_root="results/logs/tmaze_active/tmaze_snn_actor_snntiming_critic_active",
        ann_mode="ann",
        snn_mode="snn_actor_snn_timing_critic",
    ),
    TaskSpec(
        ...
        snn_root="results/logs/tmaze_passive/tmaze_snn_actor_snntiming_critic_passive",
        ann_mode="ann",
        snn_mode="snn_actor_snn_timing_critic",
    ),
]
